...
An RP2040-based acid bassline synthesizer and drum machine built on the Mozzi audio library. Two instruments in one device, a 16-step acid sequencer and an 16 drum pattern groove box running simultaneously on dual cores with a 320×240 ILI9341 TFT display and 16 Cherry MX pads.
...
| File | Description |
|------|-------------|
| `Acid_Drip.ino` | Main sketch — acid synth engine, sequencer, UI |
| `Beat_Machine.ino` | Drum machine tab — DrumKid engine, 8 instruments |
...
|-------|--------|
| Pads 1+2 | Play / Stop |
| Pads 1+2 (hold 1s) | Factory reset |
...
| 10 | SCALE | Scale: CHROM / MAJ / MIN / PENT / BLUES; octave: 0/1/2 |
| 11 | SOUND | Synth voice 1–8 |
| 12 | WALK | Note walk: OFF / UP×1 / DOWN×1 / 5TH / BOUNCE / CLIMB / UP×2 / RANDOM |
| 13 | FX | Enter FX assign sub-mode |
| 14 | TEMPO | Preset BPM: 100/110/120/128/133/138/145/160 — or tap repeatedly for tap tempo |
| 15 | PLEN | Pattern length 1–16 (top row = 1–8, bottom row = 9–16) |
| 16 | PAT> | Playback order: FWD / CW / ALT / REV / SKIP2 / SKIP3 / PING / RND |

### FX Assign (FUNC → pad 13)

1. Press a top-row pad to select an effect:
   `None / Oct Up / Retrigger / Oct Down / Major Arp / Minor Arp / Overdrive / Bit Crush`
...
Hold a drum pad (1–5) and turn the pots:
...
16 patterns selectable from the grid — BASIC, HOUSE, TECHNO, ACIDTRK, HALFTM, FUNKY, SWING, BREAKBT, MINML, LATIN, HIPHOP, BLUMND, DNBTEC, TRIPLT, GBLDWN, GHOST.
